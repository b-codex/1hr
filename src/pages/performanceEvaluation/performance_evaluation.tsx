import EmployeePerformanceEvaluationManagement from '@/Roles/Employee/PE';
...
const PerformanceEvaluation = () => {
    ...
    if (role === 'employee') {
        return (
            <>
                <EmployeePerformanceEvaluationManagement />
            </>
        )
    }
...
PerformanceEvaluation.getLayout = function getLayout(page: ReactElement) {
